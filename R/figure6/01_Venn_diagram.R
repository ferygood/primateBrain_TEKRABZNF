...
load("/path/to/github/pBrain/data/mayo_cntTable/mayoTEKRABber_balance.RData")

kznf_gene_infer <- read.csv("/path/to/github/pBrain/data/hmKZNFs337_ageInfer.csv")
young_kznf <- kznf_gene_infer %>%
    filter(branch>=8)
te_infer <- read.csv("/path/to/github/pBrain/data/Dfam_TE_simiiformes.csv")
