...
hmExp_tpm <- readRDS("/path/to/data/hmExp_tpm.rds")
hmCorr_tpm <- readRDS("/path/to/data/hmCorr_tpm.rds")
read_rds_files("/path/to/posts/brain/CorrDEanalysis/results_rdata/")
...
tidyHeatmap::save_pdf(
    ...
    width= 5,
    height=8,
    filename="figures/lowTEcheck/low_percentage.pdf"
)
